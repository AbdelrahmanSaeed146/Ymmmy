...
function showSearch() {
  ...
  <div class="row py-4 ">
      <div class="col-md-6 ">
          <input id="byName"   class="form-control  text-black" type="text" placeholder="Search By Name">
      </div>
      <div class="col-md-6">
          <input id = "byF" maxlength="1" class="form-control  text-black" type="text" placeholder="Search By First Letter">
      </div>
  </div>`;
